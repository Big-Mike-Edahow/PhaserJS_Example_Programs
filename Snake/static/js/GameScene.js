...
export default class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("food", "images/game/food.png");
...
function repositionFood() {
  /* We can place the food anywhere in our 40x30 grid,
     except on-top of the snake, so we need to filter those
     out of the possible food locations. If there aren't
     any locations left, they've won!
