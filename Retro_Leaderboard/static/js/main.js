...
class Starfield extends Phaser.Scene {
  ...
  preload() {
    this.load.image("star", "static/images/star4.png");
  }
...
class Highscore extends Phaser.Scene {
  ...
  preload() {
    this.load.image("block", "static/images/block.png");
    this.load.image("rub", "static/images/rub.png");
    this.load.image("end", "static/images/end.png");

    this.load.bitmapFont(
      "arcade",
      "static/fonts/bitmap/arcade.png",
      "static/fonts/bitmap/arcade.xml",
    );
  }
  ...
  submitName() {
    ...
    this.add
      .bitmapText(70, 100, "arcade", "All Time High Scores!")
      .setTint(0xff69B4);
    this.add
