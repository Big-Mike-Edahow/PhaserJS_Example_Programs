...
class Intro extends Phaser.Scene {
  ...
  create() {
    ...
    this.highlight = this.add
      .rectangle(0, 260, 640, 70, 0x0182fb)
      .setOrigin(0)
      .setAlpha(0.75);
    ...
    const zone1 = this.add.zone(0, 260, 640, 70).setOrigin(0);
    const zone2 = this.add.zone(0, 320, 640, 70).setOrigin(0);
    const zone3 = this.add.zone(0, 380, 640, 70).setOrigin(0);
...
class MineSweeper extends Phaser.Scene {
  ...
  create() {
    this.add.image(0, 0, "win95").setDisplaySize(640, 480).setOrigin(0);
